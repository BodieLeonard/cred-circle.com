...
function injectPluginScript(pathPrefix) {
    ...
    injectScript('http://local.dropbox.com/bl-homepage/homepageapp/www/scripts/libs/cordova/3.0/cordova_plugins.js', function(){
        try {
...
function findCordovaPath() {
    ...
    //return path;
    return "http://local.dropbox.com/bl-homepage/homepageapp/www/scripts/libs/cordova/3.0/cordova.js";
}
